...
class MyPopupDialog(QtGui.QDialog):
    ...
    def saveUserProfile(self):
        ...
        filename= QtGui.QFileDialog.getSaveFileName(self, 'Save Files', "Connections/Shear/cleatAngle/output/Profile",  '*.txt')
    ...
    def useUserProfile(self):
        ...
        filename = QtGui.QFileDialog.getOpenFileName(self, 'Open Files', "Connections/Shear/cleatAngle/output/Profile", "All Files (*)")
...
#         uiObj['Load']['ShearForce (kN)'] = float(self.ui.txtShear.text().toInt()[0])
    ...
    def save_design(self,popup_summary):
        ...
        fileName,pat =QtGui.QFileDialog.getSaveFileNameAndFilter(self,"Save File As","Connections/Shear/cleatAngle/output","All Files (*);;Html Files (*.html)")
...
#         self.outdict = self.resultObj#self.outputdict()
        ...
        pdfkit.from_file(fileName,'Connections/Shear/cleatAngle/output/report.pdf')
...
#         self.ui.btnSvgSave.setEnabled(False)
    ...
    def call_2d_Drawing(self,view):
        ...
        if view == "All":
            ...
            self.display.set_bg_gradient_color(255,255,255,255,255,255)
            self.display.ExportToImage('Connections/Shear/cleatAngle/output/3D_Model.png')
