...
# Header of the pdf fetched from dialogbox
    rstr = t('table')
    rstr += t('tr')
    row = [0, '<object type= "image/PNG" data= "Fossee_logo.png"','Created with'' &nbsp'' &nbsp' '<object type= "image/PNG" data= "Osdag_header.png" width= 150></object>']
...
# Header of the pdf fetched from dialogbox
    rstr += t('table')
    rstr += t('tr')
    row = [0, '<object type= "image/PNG" data= "Fossee_logo.png"','Created with'' &nbsp' '<object type= "image/PNG" data= "Osdag_header.png" width= 150></object>']
    rstr += t('td colspan="2" align= "center" class= "viewbl" ') + space(row[0]) + row[1] + t('/td')
...
#Digram
    ...
    row = [0, '<object type="image/svg+xml" data="cleatSide.svg" width ="480"></object>', '<object type="image/svg+xml" data="cleatFront.svg" width ="630"></object>']
    rstr += t('tr')
    rstr += t('td align="center" class=" viewtbl"') + space(row[0]) + row[1] + t('/td')
    rstr += t('td align="center" class=" viewtbl "') + row[2] + t('/td')
    rstr += t('/tr')
