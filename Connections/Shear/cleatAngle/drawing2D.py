    ...
    def saveToSvg(self,fileName,view):
        ...
        if self.connectivity == 'Column flange-Beam web':
            if view == "Front":
                ...
                fileName = 'Connections/Shear/cleatAngle/output/cleatFront.svg'
                fin2DFront.callCFBWfront(fileName)
                fileName = 'Connections/Shear/cleatAngle/output/cleatSide.svg'
                fin2DSide.callCFBWSide(fileName)
                fileName = 'Connections/Shear/cleatAngle/output/cleatTop.svg'
                fin2DTop.callCFBWTop(fileName)
