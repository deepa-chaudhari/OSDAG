...
#Design Check
    ...
    row =[0,"Plate thickness (mm)","&#8805; "+minplatethk,plateThick, ""]
    rstr += t('td class="header2_col1"') + space(row[0]) + row[1] + t('/td')
    rstr += t('td class="header2"') + space(row[0]) + row[2] + t('/td')
    rstr += t('td class="header2"') + space(row[0]) + row[3] + t('/td')
    rstr += t('td class="header2"') + space(row[0]) + row[4] + t('/td')
    ...
    row = [0, "Plate height (mm)", "&#8805;0.6*" + beam_d+ "=" + minLen+ ", &#8804;" + beam_d+ strmaxLen+ "="+maxLen+"<br> [cl. 10.2.4, Insdag Detailing Manual, 2002]",plateLength," <p align=right style=color:green><b>Pass</b></p>","300", ""]#     else
    rstr += t('td class="header2_col1"') + space(row[0]) + row[1] + t('/td')
    rstr += t('td class="header2"') + space(row[0]) + row[2] + t('/td')
    rstr += t('td class="header2"') + space(row[0]) + row[3] + t('/td')
    rstr += t('td class="header2"') + space(row[0]) + row[4] + t('/td')
    ...
    row = [0, "Plate Width (mm)", "&#8805;"+ minWidth+ ", &#8804;" + strmaxWidth+ "="+maxWidth+"<br>",plateWidth," <p align=right style=color:green><b>Pass</b></p>","300", ""]#     else
    ...
    row =[0,"Weld strength (kN/mm)"," &#8804; "+weld_shear,"<i>f<i><sub>v<sub> =(0.7*"+weldSize+"*"+weld_fu+")/(&#8730;3*1.25*1000)<br> = "+weld_strength," <p align=right style=color:green><b>Pass</b></p>"]
...
#Digram
    ...
    row = [0, '<object type="image/PNG" data="3D_Model.png" width ="400"></object>', '<object type="image/svg+xml" data="endTop.svg" width ="400"></object>']
    rstr += t('tr')
    rstr += t('td  align="center" class=" viewtbl"') + space(row[0]) + row[1] + t('/td')
    rstr += t('td  align="center" class=" viewtbl"') + row[2] + t('/td')
    rstr += t('/tr')
     
    row = [0, '<object type="image/svg+xml" data="endSide.svg" width ="400"></object>', '<object type="image/svg+xml" data="endFront.svg" width ="400"></object>']
    rstr += t('tr')
    rstr += t('td align="center" class=" viewtbl"') + space(row[0]) + row[1] + t('/td')
    rstr += t('td align="center" class=" viewtbl "') + row[2] + t('/td')
    rstr += t('/tr')
