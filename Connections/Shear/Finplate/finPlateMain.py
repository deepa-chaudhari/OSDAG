...
#         self.dictcoldata = self.fetchColumnPara()
    ...
    def save_design(self,popup_summary):
        ...
        pdfkit.from_file(fileName,'output/finplate/'+base+'.pdf', options=options)
    ...
    def save_log(self):
        ...
        fileName,pat = QtGui.QFileDialog.getSaveFileNameAndFilter(self,"Save File As","output/finplate/errorMessages","Text files (*.txt)")
    ...
    def call2D_Drawing(self,view):
        ...
        if view == "All":
            ...
            fileName = QtGui.QFileDialog.getSaveFileName(self,
                    "Save SVG", 'output/finplate/2DImages/untitle.svg',
                    "SVG files (*.svg)")
            f = open(fileName,'w')
